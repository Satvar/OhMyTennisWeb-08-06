...
@Component({
  selector: "app-jeuxconcour",
  templateUrl: "./jeuxconcour.component.html",
  styleUrls: ["./jeuxconcour.component.scss"]
})
export class JeuxconcourComponent extends AppComponent implements OnInit {
