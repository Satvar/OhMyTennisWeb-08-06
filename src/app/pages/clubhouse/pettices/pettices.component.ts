...
@Component({
  selector: "app-pettices",
  templateUrl: "./pettices.component.html",
  styleUrls: ["./pettices.component.scss"]
})
export class PetticesComponent extends AppComponent implements OnInit {
