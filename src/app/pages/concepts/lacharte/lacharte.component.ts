...
@Component({
  selector: "app-lacharte",
  templateUrl: "./lacharte.component.html",
  styleUrls: ["./lacharte.component.scss"]
})
export class LacharteComponent extends AppComponent implements OnInit {
