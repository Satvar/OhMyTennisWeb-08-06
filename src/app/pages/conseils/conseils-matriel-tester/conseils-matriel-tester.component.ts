...
@Component({
  selector: "app-couseil-matriel-tester",
  templateUrl: "./conseils-matriel-tester.component.html",
  styleUrls: ["./conseils-matriel-tester.component.scss"]
})
export class ConseilsMatrielTesterComponent extends AppComponent
  implements OnInit {
