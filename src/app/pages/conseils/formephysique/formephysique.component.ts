...
@Component({
  selector: "app-formephysique",
  templateUrl: "./formephysique.component.html",
  styleUrls: ["./formephysique.component.scss"]
})
export class FormephysiqueComponent extends AppComponent implements OnInit {
