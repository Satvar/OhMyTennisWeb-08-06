...
@Component({
  selector: "app-premiercours",
  templateUrl: "./premiercours.component.html",
  styleUrls: ["./premiercours.component.scss"]
})
export class PremiercoursComponent extends AppComponent implements OnInit {
