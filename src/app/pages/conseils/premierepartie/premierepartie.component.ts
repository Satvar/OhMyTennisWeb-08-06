...
@Component({
  selector: "app-premierepartie",
  templateUrl: "./premierepartie.component.html",
  styleUrls: ["./premierepartie.component.scss"]
})
export class PremierepartieComponent extends AppComponent implements OnInit {
