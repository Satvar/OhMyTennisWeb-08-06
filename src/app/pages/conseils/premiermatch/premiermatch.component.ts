...
@Component({
  selector: "app-premiermatch",
  templateUrl: "./premiermatch.component.html",
  styleUrls: ["./premiermatch.component.scss"]
})
export class PremiermatchComponent extends AppComponent implements OnInit {
