...
@Component({
  selector: "app-premiertournoi",
  templateUrl: "./premiertournoi.component.html",
  styleUrls: ["./premiertournoi.component.scss"]
})
export class PremiertournoiComponent extends AppComponent implements OnInit {
