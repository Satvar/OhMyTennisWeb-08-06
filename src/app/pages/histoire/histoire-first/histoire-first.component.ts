...
@Component({
  selector: "app-histoire-first",
  templateUrl: "./histoire-first.component.html",
  styleUrls: ["./histoire-first.component.scss"]
})
export class HistoireFirstComponent extends AppComponent implements OnInit {
