...
@Component({
  selector: "app-histoire-four",
  templateUrl: "./histoire-four.component.html",
  styleUrls: ["./histoire-four.component.scss"]
})
export class HistoireFourComponent extends AppComponent implements OnInit {
