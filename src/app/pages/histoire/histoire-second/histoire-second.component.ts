...
@Component({
  selector: "app-histoire-1930-1950",
  templateUrl: "./histoire-second.component.html",
  styleUrls: ["./histoire-second.component.scss"]
})
export class HistoireSecondComponent extends AppComponent implements OnInit {
