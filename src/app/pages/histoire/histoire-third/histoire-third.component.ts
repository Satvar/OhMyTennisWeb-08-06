...
@Component({
  selector: "app-histoire-1950-1973",
  templateUrl: "./histoire-third.component.html",
  styleUrls: ["./histoire-third.component.scss"]
})
export class HistoireThirdComponent extends AppComponent implements OnInit {
