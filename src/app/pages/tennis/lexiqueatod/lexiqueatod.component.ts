...
@Component({
  selector: "app-lexiqueatod",
  templateUrl: "./lexiqueatod.component.html",
  styleUrls: ["./lexiqueatod.component.scss"]
})
export class LexiqueatodComponent extends AppComponent implements OnInit {
