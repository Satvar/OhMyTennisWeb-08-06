...
@Component({
  selector: "app-lexiqueetom",
  templateUrl: "./lexiqueetom.component.html",
  styleUrls: ["./lexiqueetom.component.scss"]
})
export class LexiqueetomComponent extends AppComponent implements OnInit {
