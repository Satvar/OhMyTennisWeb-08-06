...
@Component({
  selector: "app-lexiquentoq",
  templateUrl: "./lexiquentoq.component.html",
  styleUrls: ["./lexiquentoq.component.scss"]
})
export class LexiquentoqComponent extends AppComponent implements OnInit {
