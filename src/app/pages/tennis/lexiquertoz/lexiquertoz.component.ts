...
@Component({
  selector: "app-lexiquertoz",
  templateUrl: "./lexiquertoz.component.html",
  styleUrls: ["./lexiquertoz.component.scss"]
})
export class LexiquertozComponent extends AppComponent implements OnInit {
